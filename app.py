...
def _apply_header_image_anchor(doc, image_path):
    ...
    for section in doc.sections:
        ...
        # extent same as page
        ext = _et.SubElement(anchor, '{http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing}extent')
        ext.set('cx', str(int(section.page_width.emu)))
        ext.set('cy', str(int(section.page_height.emu)))
