...
/* Force brand + tagline and base text to Poppins */
html, body, [data-testid="stAppViewContainer"] { font-family: 'Poppins', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif !important; }
.brand, .brand *, .brand-title, .brand-tagline { font-family: 'Poppins', sans-serif !important; }

/* Make inputs look half-width inside columns */
...
with row3c2:
    st.write("")
# (removed duplicate) st.button("Generate Kundali", key="gen_btn")
    st.write("")
# === End two-per-row ===
